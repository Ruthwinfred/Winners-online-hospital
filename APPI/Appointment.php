...
<html>
<head>
  <title>Appointment form-The Winners online hospital</title>
...
<div class="container">  
  <form id="contact" action="" method="post">
    ...
    <h4>Patient appointment Form</h4>
    <fieldset>
  ...
  <select name="Problem" required>
   ...
   <fieldset>
      Chose the appointment date and time:<input type="datetime-local"  name="AppointmentDate"  required autofocus>
    </fieldset>
    <fieldset>
      <button type="submit" id="contact-submit" name="sub" value="Submit">Book appointment</button>
    </fieldset>
  </form>
</div>
<?php
...
//insert values into db
	$sql = "INSERT INTO appointment(Name,Age,Gender,Problem,HealthHistory,Habits,AOB,Feedback,Appointment)
   VALUES('$nm','$age','$gnd','$prob','$hab' ,'$aob' ,'$fb' ,'$app' ,'$dt')";

	//execute the query
	if ($conn->query($sql) === TRUE) {
        echo  "<p style='color:rgba(39, 89, 4, 0.755)'><b>Dear  ".$nm. ",  you have requested to have an appointment with us on ".$dt." . You will
        receive an appointment <br>notice shortly through ".$fb." with the cost and all details.<br>Thanks and stay safe!</b></p>";;
	}else{
