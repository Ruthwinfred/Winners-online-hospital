...
//insert values into db
   ...
   VALUES('$nm','$age','$gnd','$prob','$hab' ,'$aob' ,'$fb' ,'$app' ,'$dt')";
	...
	if ($conn->query($sql) === TRUE) {
        echo  "<p class='central'>Dear  ".$nm. ",  you have requested to have an appointment with us on ".$dt." . You will
        receive our feedback <br>notice shortly through ".$fb." with the cost and all details.<br>Thanks and stay safe!</p>";;
	}else{
